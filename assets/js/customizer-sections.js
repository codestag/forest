/* global jQuery, forestCustomizerSettings */
...
( function( api, $ ) {
	...
	var fontChoices = {
		...
		init: function() {
			...
			$.each( forestCustomizerSettings.fontOptions, function( index, key ) {
		...
		insertChoices: function() {
			$.each( fontChoices.cache.options, function( key, element ) {
				element.chosen({
					no_results_text: forestCustomizerSettings.chosen_no_results_fonts,
