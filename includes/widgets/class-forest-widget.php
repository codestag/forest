			...
			switch ( $setting['type'] ) {
				...
				?>
					...
					<p style="margin-top: 3px;">
						...
						<a href="#" class="button-secondary <?php echo esc_attr( $this->get_field_id( $key ) ); ?>-add" onclick="imageWidget.uploader( '<?php echo esc_js( $this->id ); ?>', '<?php echo esc_js( $id_prefix ); ?>', '<?php echo esc_js( $key ); ?>' ); return false;"><?php esc_html_e( 'Choose Image', 'stag' ); ?></a>
						<a href="#" style="display:inline-block;margin:5px 0 0 3px;<?php if ( empty( $value ) ) echo 'display:none;'; ?>" id="<?php echo esc_attr( $id_prefix ); ?>remove" class="button-link-delete" onclick="imageWidget.remove( '<?php echo esc_js( $this->id ); ?>', '<?php echo esc_js( $id_prefix ); ?>', '<?php echo esc_js( $key ); ?>' ); return false;"><?php esc_html_e( 'Remove', 'stag' ); ?></a>
					</p>
				<?php
					break;
				...
				case 'category':
					...
					$categories_dropdown = wp_dropdown_categories( array(
						...
						'selected'         => $value,
						'show_option_all'  => esc_html__( 'All Categories', 'stag' ),
						'show_option_none' => esc_html__( 'No Categories', 'stag' ),
						'show_count'       => true,
						'orderby'          => 'slug',
						'hierarchical'     => true,
						'class'            => 'widefat',
				...
				case 'tags':
					...
					$tags_dropdown = wp_dropdown_categories( array(
						'name'             => $this->get_field_name( $key ),
						'selected'         => $value,
						'show_option_all'  => esc_html__( 'All Tags', 'stag' ),
						'show_option_none' => esc_html__( 'No Tags', 'stag' ),
						'show_count'       => true,
						'orderby'          => 'slug',
						'hierarchical'     => true,
						'class'            => 'widefat',
